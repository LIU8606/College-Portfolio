...
<html>
	...
	<body>
		...
		<div class="container login-wrapper">
			<form action="../auth/edit_anncs.php?ID=<?php echo $ID; ?>" method="POST">
				<div class="row">
					<div class="col-md-8 col-md-offset-1">
						<label>標題</label>
						<input type="text" name="title" value = <?php echo $anncs[0];?> class="form-control">
					</div>
					<div class="col-md-12">
						<br>
					</div>
					<div class="col-md-8 col-md-offset-1">
						<label>內容</label>
						<br>
						<textarea name="content" style="width:450px;height:500px;"><?php echo $anncs[1];?></textarea>
					</div>
					<div class="col-md-12">
						<br><br><br>
					</div>
					<div class="col-md-6 col-md-offset-6">
						<button class="btn btn-default btn-login" type="submit">儲存</button>
